...
public class Adminlogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 170, 400, 390));
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 130, 50));
        Image image=new ImageIcon(this.getClass().getResource("images/back.png")).getImage();
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1290, 720));
        new JPanel() {
            public void paintComponent(Graphics g) {
                Image img = Toolkit.getDefaultToolkit().getImage(
                    Adminlogin.class.getResource("images/ADMINLOGIN.png"));
